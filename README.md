...
```
  1. Add the binary directory for your $GOHOME (by default ~/go/bin) to you path so you can run goreman directly to start little clusters.
  1. Make sure you can run the simple hraftd:
```
    prompt> cd hraftd
